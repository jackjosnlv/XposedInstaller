...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/com.rdc.rdcsun.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/com.rdc.rdcsun.installer/" : BASE_DIR_LEGACY;
    ...
    private static final String[] XPOSED_PROP_FILES = new String[]{
            "/su/rdcsun/rdcsun.prop", // official systemless
            "/system/rdcsun.prop",    // classical
    };
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "com.rdc.rdcsun.installer.fileprovider", new File(info.localFilename));
