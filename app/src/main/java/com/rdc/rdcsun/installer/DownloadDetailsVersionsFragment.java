...
import com.rdc.rdcsun.installer.repo.RepoParser;
import com.rdc.rdcsun.installer.util.DownloadsUtil;
import com.rdc.rdcsun.installer.util.HashUtil;
...
import com.rdc.rdcsun.installer.util.chrome.LinkTransformationMethod;
import com.rdc.rdcsun.installer.widget.DownloadView;
...
public class DownloadDetailsVersionsFragment extends ListFragment {
    ...
    private class VersionsAdapter extends ArrayAdapter<ModuleVersion> {
        ...
        public VersionsAdapter(Context context, ModuleUtil.InstalledModule installed) {
